...
import { DEFAULT_LAYERS, STEP_SETTINGS } from "../constants/imageConstants";
...
const ImageParametersStep = ({
  ...
  const {
    ...
    defaultValues: {
      ...
      layers: trainspace?.parameterData?.layers ?? DEFAULT_LAYERS.MNIST,
    },
  });
  useEffect(() => {
